    ...
    while should_keep_training:
        for i_batch, data_blob in enumerate(train_loader):
            ...
            if total_steps % VAL_FREQ == VAL_FREQ - 1:
                PATH = '/home/csj/GLS/RAFT_USDATA/checkpoints_20250224/%d_%s.pth' % (total_steps + 1, args.name)
            ...
            if total_steps > args.num_steps:
                ...
                break
    logger.close()
    PATH = '/home/csj/GLS/RAFT_USDATA/checkpoints_20250224/%s.pth' % args.name
    torch.save(model.state_dict(), PATH)
    return PATH
...
if __name__ == '__main__':
    ...
    if not os.path.isdir('/home/csj/GLS/RAFT_USDATA/checkpoints_20250224'):
        os.mkdir('/home/csj/GLS/RAFT_USDATA/checkpoints_20250224')
