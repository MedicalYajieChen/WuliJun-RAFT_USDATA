...
def fetch_optimizer(args, model):
    ...
    scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer, milestones=[1000, 3000, 6000, 10000, 15000], gamma=0.5)
    ...
    while should_keep_training:
        for i_batch, data_blob in enumerate(train_loader):
            ...
            if total_steps % VAL_FREQ == VAL_FREQ - 1:
                PATH = '/data/csj/GLS/checkpoints/RAFT_USDATA/checkpoints_quarter_noskip/%d_%s_ES.pth' % (total_steps + 1, args.name)
            ...
            if total_steps > args.num_steps:
                ...
                break
    logger.close()
    PATH = '/data/csj/GLS/checkpoints/RAFT_USDATA/checkpoints_quarter_noskip/%s_ES.pth' % args.name
    torch.save(model.state_dict(), PATH)
    return PATH
...
if __name__ == '__main__':
    ...
    if not os.path.isdir('/data/csj/GLS/checkpoints/RAFT_USDATA/checkpoints_quarter_noskip'):
        os.mkdir('/data/csj/GLS/checkpoints/RAFT_USDATA/checkpoints_quarter_noskip')
