    ...
    while should_keep_training:
        for i_batch, data_blob in enumerate(train_loader):
            ...
            if total_steps % VAL_FREQ == VAL_FREQ - 1:
                PATH = '/data/csj/GLS/checkpoints/RAFT_USDATA/pwc/checkpoints_pwc/%d_%s_add.pth' % (total_steps + 1, args.name)
            ...
            if total_steps > args.num_steps:
                ...
                break
    logger.close()
    PATH = '/data/csj/GLS/checkpoints/RAFT_USDATA/pwc/checkpoints_pwc/%s_add.pth' % args.name
    torch.save(model.state_dict(), PATH)
    return PATH
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_size', type=int, nargs='+', default=[384, 448])
    ...
    if not os.path.isdir('/data/csj/GLS/checkpoints/RAFT_USDATA/pwc/checkpoints_pwc'):
        os.mkdir('/data/csj/GLS/checkpoints/RAFT_USDATA/pwc/checkpoints_pwc')
