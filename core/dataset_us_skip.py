...
from core.utils.augmentor_skip_v2 import FlowAugmentor_v2
import cv2
import joblib
import random
...
class FlowDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.augmentor is not None:
            img1, img2, flow_1, mask_1 = self.augmentor(img1, img2, flow_1, mask_1)
        ...
        return img1, img2, flow_1, mask_1
...
class USdata_skip(FlowDataset):
    def __init__(self, aug_params=None, test=False, root='/mnt/nas/cc/USDATA/data_accuracy/'):
        ...
        validation = 'ESAOTE'
        train_images_sequence_list, train_flow_sequence_list, train_mask_sequence_list, train_seg_mask_sequence_list, train_pointsmask_sequence_list, train_coordinate_sequence_list, test_images_list, test_flow_list, test_mask_list, test_seg_mask_list, test_pointsmask_list, test_coordinate_list = get_USData_list(root, validation)
...
def get_USData_list(root_path, validation):
    ...
    for sp in suppliers:
        if sp == validation:
            ...
            images_sequence_list, flow_sequence_list, mask_sequence_list, seg_mask_sequence_list, pointsmask_sequence_list, coordinate_sequence_list = get_subset_list(root_path, sp)
    ...
    return train_images_sequence_list, train_flow_sequence_list, train_mask_sequence_list, train_seg_mask_sequence_list, train_pointsmask_sequence_list, train_coordinate_sequence_list, test_images_list, test_flow_list, test_mask_list, test_seg_mask_list, test_pointsmask_list, test_coordinate_list
...
def get_subset_list(root_path, supplier, test=False):
    ...
    if test:
        ...
        return images_sequence_list, flow_sequence_list, mask_sequence_list, seg_mask_sequence_list, pointsmask_sequence_list, coordinate_sequence_list
