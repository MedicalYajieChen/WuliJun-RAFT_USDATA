...
from core.bodermask import frame_utils
from core.bodermask.augmentor import FlowAugmentor
import cv2
import joblib
...
class FlowDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # mask_2 = np.ones(mask_1.shape) * 255
    ...
    for vn in view_name:
        for mn in mode_name:
            ...
            for i in range(len(images) - 2):
                ...
                mask_list.append([masks[i], boder_mask_path])
