...
from core.extractor import BasicEncoder, SmallEncoder, ConvNext, BasicEncoderQuarter
...
class RAFT(nn.Module):
    def __init__(self, args):
        ...
        if args.small:
            ...
            self.fnet = BasicEncoderQuarter(output_dim=256, norm_fn='instance', dropout=args.dropout)        
    ...
    def initialize_flow(self, img):
        ...
        N, C, H, W = img.shape
        rate = 4
        coords0 = coords_grid(N, H//rate, W//rate, device=img.device)
        coords1 = coords_grid(N, H//rate, W//rate, device=img.device)
