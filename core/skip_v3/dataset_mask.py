...
from core.skip_v3.augmentor_Skip_v3_mask import FlowAugmentor_v3
import cv2
import joblib
import random
...
class FlowDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # 读取分割mask
        seg_mask_1 = frame_utils.read_gray_img(self.train_seg_mask_list[index][start_index])
        ...
        if self.augmentor is not None:
            img1, img2, flow_1, mask_1, seg_mask_1, boder_mask = self.augmentor(img1, img2, flow_1, mask_1, seg_mask_1,  boder_mask)
        ...
        return img1, img2, flow_1, mask_1, seg_mask_1, boder_mask
