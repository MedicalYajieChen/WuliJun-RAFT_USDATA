...
def fetch_optimizer(args, model):
    ...
    scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer, milestones=[3000, 7000, 12000, 18000, 25000], gamma=0.5)
...
def train(args):
    model = nn.DataParallel(KPAFlow(args))
    ...
    while should_keep_training:
        for i_batch, data_blob in enumerate(train_loader):
            ...
            if total_steps % VAL_FREQ == VAL_FREQ - 1:
                PATH = '/home/csj/GLS/RAFT_USDATA/checkpoints_KPA_SA/%d_%s.pth' % (total_steps + 1, args.name)
            ...
            if total_steps > args.num_steps:
                ...
                break
    logger.close()
    PATH = '/home/csj/GLS/RAFT_USDATA/checkpoints_KPA_SA/%s.pth' % args.name
    torch.save(model.state_dict(), PATH)
    return PATH
...
if __name__ == '__main__':
    ...
    if not os.path.isdir('/home/csj/GLS/RAFT_USDATA/checkpoints_KPA_SA'):
        os.mkdir('/home/csj/GLS/RAFT_USDATA/checkpoints_KPA_SA')
