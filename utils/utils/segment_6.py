...
def segment_6(mask, mask1, points=False):
    ...
    #
    #     cv2.circle(mask1, left_point_s, 2, (0, 255, 255), -1, 0)
    #     cv2.circle(mask1, right_point_s, 2, (0, 255, 255), -1, 0)
    # #
    # cv2.imshow('1', mask1)
    # cv2.waitKey()
    left_points = [[], [], []]
    ...
    for k in range(len(left_points_de) - 1):
        i = k + 1
    ...
    if points:
        return [left_point, right_point, left_points[0][0], right_points[0][-1], left_points[1][0], left_points[1][-1], \
                right_points[1][0], right_points[1][-1], left_points[2][0], left_points[2][-1], right_points[2][0],
                right_points[2][-1]]
    else:
        return mask1
