...
def train(args):
    ...
    if args.restore_ckpt:
        ...
        model_without_ddp.load_state_dict(weights, strict=True)
    ...
    while should_keep_training:
        for i_batch, data_blob in enumerate(train_loader):
            ...
            if total_steps % VAL_FREQ == VAL_FREQ - 1:
                PATH = '/data/csj/meflow_checkpoints/stage1/%d_HI_%s.pth' % (total_steps + 1, args.name)
            ...
            if total_steps > args.num_steps:
                ...
                break
    logger.close()
    PATH = '/data/csj/meflow_checkpoints/stage1/%s_es.pth' % args.name
    torch.save(model.state_dict(), PATH)
    return PATH
...
if __name__ == '__main__':
    ...
    if not os.path.isdir('/data/csj/meflow_checkpoints/stage1/'):
        os.mkdir('/data/csj/meflow_checkpoints/stage1/')
